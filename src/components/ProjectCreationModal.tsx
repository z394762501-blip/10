      ...
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full mx-4">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-xl font-semibold text-gray-900">{t('projectCreation.title')}</h2>
          </div>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="mb-6">
            ...
            <input
              ...
              placeholder={t('projectCreation.placeholder')}
              required
              autoFocus
            />
          </div>
          ...
          <div className="bg-blue-50 p-4 rounded-lg mb-6">
            <h3 className="text-sm font-medium text-blue-900 mb-2">{t('projectCreation.template')}</h3>
            <p className="text-sm text-blue-700">
              {t('projectCreation.templateDesc')}
            </p>
          </div>
          ...
          <div className="flex items-center justify-end space-x-3">
            ...
            >
              ...
              {isCreating ? t('projectCreation.creating') : t('projectCreation.create')}
            </button>
          </div>
        </form>
      </div>
