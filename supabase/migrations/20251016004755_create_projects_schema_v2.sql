...
-- 项目预算策略
DROP POLICY IF EXISTS "Allow all operations on project budgets" ON project_budgets;
...
-- 项目阶段策略
DROP POLICY IF EXISTS "Allow all operations on project phases" ON project_phases;
...
-- 阶段附件策略
DROP POLICY IF EXISTS "Allow all operations on phase attachments" ON phase_attachments;
...
-- 阶段评审人策略
DROP POLICY IF EXISTS "Allow all operations on phase reviewers" ON phase_reviewers;
...
-- 项目风险策略
DROP POLICY IF EXISTS "Allow all operations on project risks" ON project_risks;
...
-- 项目团队成员策略
DROP POLICY IF EXISTS "Allow all operations on project team members" ON project_team_members;
...
-- 项目会议策略
DROP POLICY IF EXISTS "Allow all operations on project meetings" ON project_meetings;
...
-- 项目利益相关者策略
DROP POLICY IF EXISTS "Allow all operations on project stakeholders" ON project_stakeholders;
